...

{
...

    {
        ...
        public void Test2()
        {
            ...
            Container con1 = sh.containerList["con1"]; Container con2 = sh.containerList["con2"];
        ...
        public void Test3()
        {
            ...
            foreach (KeyValuePair<string, Container> ele1 in sh1.containerList)
        ...
        public void Test4()
        {
            ...
            Assert.IsTrue(con1.name == "test");



            Container con2 = new Container("con2", true);
            Assert.IsTrue(con2.integer);



            Sheet sh1 = new();
            sh1.containerList.Add(con1.name, con1); sh1.containerList.Add(con2.name, con2);



            Assert.AreNotSame(sh1.getContainer("test"), sh1.getContainer("con2"));



            Assert.AreSame(sh1.getContainer("test"), con1);
            Assert.AreSame(sh1.getContainer("con2"), con2);
